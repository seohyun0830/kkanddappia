...
class Stage3Tutorial:
    ...
    def __init__(self, screen):
        ...
        self.pages = [
            ...
            ("압력이 40이하로 떨어지면 \n 파이프 내부에 음압 차이로\n 격벽이 자동으로 닫히고 \n이동효율도 크게 떨어집니다 ", pygame.Rect(26, 575, 161, 204),["images/stage3/irongate.jpg"]),
            ("저압상태로 오래 있게 되면 HP가 감소합니다", pygame.Rect(970, 733, 230, 67),[]),
            ("압력이 70이상이면 단선 발생확률이 증가합니다", pygame.Rect(26, 575, 161, 204),["images/stage3/broken.png"]),
            ("단선이 발생하면 도착지점은 활성화 되지 않아요", pygame.Rect(931, 729, 19,19),["images/stage3/broken.png"]),
            ("비상상황이라고 너무 놀라지 마세요\n 미니드론이 도와줄거에요", pygame.Rect(0,0,0,0),["images/stage3/drone.png"]),
            ("드론이 텔레포트 아이템을 떨어뜨립니다\n R키를 누르면 이동하고 싶은 단선을 선택해\n 순간이동 할 수 있어요", pygame.Rect(0,0,0,0),["images/stage3/teleport.png","images/stage3/rkey.png"]),
            ("방향키로 움직일 수 있습니다", pygame.Rect(252,48,19,19),["images/stage3/arrowkey.png"]),
            ("압력은 Q키와 W로 직접 조절할 수 있습니다", pygame.Rect(0, 0, 0, 0),["images/stage3/qwekey.png"]),
            ("단선은 E키를 2초간 꾹 눌러 수리하세요", pygame.Rect(0, 0, 0, 0),["images/stage3/qwekey.png","images/stage3/broken.png"]),
            ("여기까지 도착하면 성공!", 
    ...
    def run(self, stage3):
        for text, rect, img_paths in self.pages:
            self.show_page(stage3, text, rect,img_paths)
    ...
    def show_page(self, stage3, text, rect,img_paths):
        ...
        while showing:
            ...
            next_surf = guide_font.render("SPACE 를 눌러 계속", True, (200, 200, 200))
            next_rect = next_surf.get_rect(
                center=(constants.SCREEN_WIDTH//2, constants.SCREEN_HEIGHT - 80)
            )
