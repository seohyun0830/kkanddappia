...
class Stage3Tutorial:
    ...
    def __init__(self, screen):
        ...
        self.pages = [
            ...
            ("불안정상태로 오래 있게 되면 HP가 감소합니다", pygame.Rect(970, 733, 230, 67), []),
            ...
            ("드론이 텔레포트 아이템을 떨어뜨립니다\n R키를 누르면 이동하고 싶은 단선을 선택해\n 순간이동 할 수 있어요\n아이템은 최대 2개까지 획득 가능해요", pygame.Rect(0, 0, 0, 0),
             ["images/stage3/teleport.png", "images/stage3/rkey.png"]),
            ("wsad키로 움직일 수 있습니다", pygame.Rect(252, 48, 19, 19),
             ["images/stage3/arrowkey.png"]),
            ("압력은 <-키와 ->로 직접 조절할 수 있습니다", pygame.Rect(0, 0, 0, 0),
             ["images/stage3/pressurekey.png"]),
